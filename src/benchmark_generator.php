...
function fopenPhpFile(string $name, bool $writePhpHeader = true)
{
...
function writeFunctionsFile()
{
    ...
    for ($i = 1; $i <= 100; $i++) {
        $code = <<<CODE
function overloadFunction$i(int \$index)
{
...
function writeMacrosFile()
{
    ...
    for ($i = 1; $i <= 100; $i++) {
        $code = <<<CODE
function overloadMacro$i(int \$index)
{
...
function writeBlocksFile()
{
    ...
    for ($i = 1; $i <= 50; $i++) {
        $code = <<<CODE
function overloadBlock$i(int \$index)
{
